...
NUMERIC_FEATURES = INT_FEATURES + ["MAX_HEIGHT","AREA", "MEDIAN_CORRELATION", "CIRCLENESS", "ELLIPSE_COMBINED_MSE", "ELLIPSE_ASYMMETRY", "NICE_V", "ELEVATION", "NEIGHBOURS_GOOD", "NEIGHBOURS_TOTAL", "RAW_COLS", "RAW_ROWS", "KNN_PROB","ELLIPSE_VERT_MSE", "LR_PROB", "SCORE", "FURROW_DISTANCE", "DITCH_DISTANCE", "NOISE1", "NOISE2", "NOISE3", "LC_PROB", "SVM_PROB", "SVM_G", "SVM_GV2.1"]
